    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <button class="btn" onclick="location.href='view_project.jsp'">View Projects</button>
                <button class="btn" onclick="location.href='edit_project.jsp'">Edit Projects</button>
            </div>
        </div>
    </div>
</div>
